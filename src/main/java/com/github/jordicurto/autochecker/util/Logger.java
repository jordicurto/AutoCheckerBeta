...
public class Logger {
	 ...
	 * @param logMessageTag
	 *            A tag identifying a group of log messages. Should be a
	 *            constant in the class calling the logger.
	 * @param logMessage
	 *            The message to add to the log.
	 */
	public static void i(Context context, String logMessageTag,
			String logMessage) {
	 ...
	 *            The message to add to the log.
	 */
	public static void e(Context context, String logMessageTag,
			String logMessage) {
	 ...
	 */
	public static void e(Context context, String logMessageTag,
			String logMessage, Throwable throwableException) {
		if (!Log.isLoggable(logMessageTag, Log.ERROR))
			return;
	...
	// The i and w method for info and warning logs should be implemented in the
	// same way as the e method for error logs.
	 ...
	 *            The message to add to the log.
	 */
	public static void v(Context context, String logMessageTag,
			String logMessage) {
	...
	// The d method for debug logs should be implemented in the same way as the
	// v method for verbose logs.
	...
	private static String getDateTimeStamp() {
		...
		return (DateFormat.getDateTimeInstance(DateFormat.SHORT,
				DateFormat.SHORT, Locale.CANADA_FRENCH).format(dateNow));
	}
	 ...
	 *            The message to add to the log.
	 */
	private static void logToFile(Context context, String logMessageTag,
			String logMessage) {
		try {
